        ...
        (function () {
            ...
            loginHolder.addEventListener("submit", (e) => {
                ...
                auth.signInWithEmailAndPassword(email, password).then((cred) => {
                    document.querySelector("#login-email").style.border = "solid 2px green";
                    window.location.replace("menu.html")
                }).catch(error => document.querySelector("#login-password").style.border = "solid 1px red"
                    , document.querySelector("#login-email").style.border = "solid 1px red"), console.log(email), console.log(password);
            })
        })();
    })